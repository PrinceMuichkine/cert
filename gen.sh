...
openssl req -x509 -newkey rsa:4096 -days 365 -nodes -keyout ca-key.pem -out ca-cert.pem -subj "/C=MN/ST=Moon/L=Solar System/O=moon.africa/OU=Stellar Transportation/CN=*.moon.africa/emailAddress=captain@moon.africa"
...
openssl req -newkey rsa:4096 -nodes -keyout server-key.pem -out server-req.pem -subj "/C=MN/ST=Moon/L=Solar System/O=moon.africa/OU=Stellar Transportation/CN=*.moon.africa/emailAddress=captain@moon.africa"
